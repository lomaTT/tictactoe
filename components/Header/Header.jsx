...
export function Header() {
    return (
        <header className="flex h-24 items-center px-8 bg-white shadow-lg">
            ...
            <button className="ml-auto flex items-center gap-2 text-start text-teal-600 hover:text-teal-500 transition-colors max-w-xs w-lg">
                <Image
                    src={avatarSrc}
                    alt="avatar"
                    width={48}
                    ...
                    unoptimized
                />
                <div className="text-lg leading-tight">llleshikfdsfs</div>
                <br />
